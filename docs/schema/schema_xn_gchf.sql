...
CREATE TABLE `thf_channel_bank` (
  ...
  `order_amount` bigint(32) DEFAULT 0,
  `day_amount` bigint(32) DEFAULT 0,
  `month_amount` bigint(32) DEFAULT 0,
...
CREATE TABLE `thf_user` (
  ...
  `user_refree` varchar(32) DEFAULT NULL COMMENT '推荐人',
