...
import com.cdkj.gchf.dto.req.XN630075Req;
 ...
 * @history:
 */
public class XN630075 extends AProcessor {

    private IUserAO userAO = SpringContextHolder.getBean(IUserAO.class);

    private XN630075Req req = null;
    ...
    public void doCheck(String inputparams, String operator)
        ...
        req = JsonUtil.json2Bean(inputparams, XN630075Req.class);
