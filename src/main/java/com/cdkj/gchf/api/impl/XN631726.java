...
public class XN631726 extends AProcessor {
    ...
    public void doCheck(String inputparams, String operator)
        ...
        req = JsonUtil.json2Bean(inputparams, XN631726Req.class);
