 ...
 * @history:
 */
public class XN631908 extends AProcessor {
    private ITeamMasterAO teamMasterAO = SpringContextHolder
        .getBean(ITeamMasterAO.class);

    private XN631908Req req = null;

    @Override
    public Object doBusiness() throws BizException {
        teamMasterAO.uploadTeamMaster(req);
    ...
    public void doCheck(String inputparams, String operator)
        ...
        req = JsonUtil.json2Bean(inputparams, XN631908Req.class);
