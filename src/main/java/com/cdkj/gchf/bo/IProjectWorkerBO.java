...
public interface IProjectWorkerBO extends IPaginableBO<ProjectWorker> {
     ...
     */
    ProjectWorker saveProjectWorker(Project project, TeamMaster teamMaster, WorkerInfo workerInfo,
            XN631696Req req);
     ...
     */
    void refreshLastPayRoll(String code, String lastPayMonth, String lastPayRollTotalAmount,
            String lastPayRollActualAmount);
    ...
    /**
     * @param projectWorkerCode 项目人员编号
     * @param bankCardCode 银行卡编号
     */
    void refreshProjectWorkerBankCardInfo(String projectWorkerCode, String bankCardCode);
     ...
     */
    void refreshProjectWorkerBankCardInfo(String projectWorkerCode);
    /**
     * 修改项目人员上传状态
     */
     ...
     * @param code pk code
     */
    void updateLastExitEntryData(String code);
     ...
     * @param code 项目人员code
     */
    void updateLastAttendanceData(String code, String workerAttendanceCode);
     ...
     * @param code 项目人员code
     */
    void updateLastPayRollData(String code);
