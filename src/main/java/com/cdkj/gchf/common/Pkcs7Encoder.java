...
public class Pkcs7Encoder {
    ...
    // 默认对称解密算法初始向量 iv
    static byte[] iv = { 0x30, 0x31, 0x30, 0x32, 0x30, 0x33, 0x30, 0x34, 0x30,
     ...
     * @return 加密的结果
     */
    public static byte[] encryptOfDiyIV(byte[] content, byte[] keyBytes,
            byte[] ivs) {
     ...
     * @return
     */
    public static byte[] decryptOfDiyIV(byte[] encryptedData, byte[] keyBytes,
            byte[] ivs) {
        byte[] encryptedText = null;
        init(keyBytes);
        System.out.println("IV：" + new String(ivs));
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
            encryptOfDiyIV(src.getBytes(), key.getBytes(), iv.getBytes()));
    }
}
