...
public class ConvertVideoPakcet {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String rtmpPath = "rtmp://localhost:1936/hls";
        ...
        String rtspPath = "rtsp://admin:1111@115.236.183.70/1/1";
    ...
    public static void test(String rtmpPath, String rtspPath, int audioRecord, boolean saveVideo)
            throws Exception {
        ...
        FFmpegFrameRecorder recorder = new FFmpegFrameRecorder(rtmpPath, width, height,
                audioRecord);
