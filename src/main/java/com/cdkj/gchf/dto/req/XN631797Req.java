...
public class XN631797Req {
    ...
    /**
     * code : 编号 phone : 手机号 politicsType : 政治面貌 cultureLevelType :  文化程度 isJoined :  是否加入公会
     * specialty : 特长 hasBadMedicalHistory : 是否有重大病史 maritalStatus : 婚姻状况 urgentLinkMan :  紧急联系人姓名
     * urgentLinkManPhone : 紧急联系电话 userId : 用户id joinedTime : 加入公会时间
     */
