...
/**
 * @ClassName: EWorkerContractUploadStatus
 * @Description: 劳动合同上传状态
 * @author: Old3
 * @date: 2019年4月30日 上午10:39:59
 * @Copyright:
 */
public enum EWorkerContractUploadStatus {
    ...
    public static EWorkerContractUploadStatus getUploadStatus(String code) {
