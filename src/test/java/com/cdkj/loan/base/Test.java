...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        File Mapperfile = new File(
            "C:/Users/CYL/git/xn-gchf/src/main/resources/mybatis",
            Key + "Mapper.xml");

        File IDAOfile = new File(
            "C:/Users/CYL/git/xn-gchf/src/main/java/com/cdkj/gchf/dao",
            "I" + Key + "DAO.java");

        File DAOImplfile = new File(
            "C:/Users/CYL/git/xn-gchf/src/main/java/com/cdkj/gchf/dao/impl",
            Key + "DAOImpl.java");

        File IBOfile = new File(
            "C:/Users/CYL/git/xn-gchf/src/main/java/com/cdkj/gchf/bo",
            "I" + Key + "BO.java");

        File BOImplfile = new File(
            "C:/Users/CYL/git/xn-gchf/src/main/java/com/cdkj/gchf/bo/impl",
            Key + "BOImpl.java");

        File IAOfile = new File(
            "C:/Users/CYL/git/xn-gchf/src/main/java/com/cdkj/gchf/ao",
            "I" + Key + "AO.java");

        File AOImplfile = new File(
            "C:/Users/CYL/git/xn-gchf/src/main/java/com/cdkj/gchf/ao/impl",
            Key + "AOImpl.java");
        try {
